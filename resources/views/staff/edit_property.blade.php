...
<div class="main-content">
    <section class="section">
      ...
      <div class="section-body property_box">
            ...
            <div class="row mt-4">
                <form action="{{ route('staff.property.update', $property->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                        <div class="card mb-4">
  ...
  <script>
    ...
    function deleteSliderImg(id){
        ...
        $.ajax({
            type: 'GET',
            url: "{{ url('staff/property-slider-img/') }}"+"/"+ id,
    ...
    function deletePdfFile(id){
        ...
        $.ajax({
            type: 'GET',
            url: "{{ url('staff/property-delete-pdf/') }}"+"/"+ id,
            success: function (response) {
                if(response.success){
                    toastr.success(response.success)
    ...
    function existNearestLocation(id){
        ...
        $.ajax({
            type: 'GET',
            url: "{{ url('staff/exist-nearest-location/') }}"+"/"+ id,
            success: function (response) {
                if(response.success){
                    toastr.success(response.success)
