...
@section('title')
    <title>{{ __('admin.My Property') }}</title>
@endsection
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @forelse($languages as $key => $language)
                                                            ...
                                                            <a
                                                                href="{{ route('admin.property.translation', ['id' => $property->id, 'code' => $language->code]) }}">{{ strtoupper($language->code) }}</a>
                                                            @if (!$loop->last)
                                                                ||
                                                            @endif
                                                        @empty
                                                            <a
                                                                href="{{ route('admin.property.translation', ['id' => $property->id, 'code' => $language->code]) }}">{{ strtoupper(config('app.locale')) }}</a>
                                                        @endforelse
                                                    </td>
                                                    <td>
