...
@section('title')
    <title>{{ __('admin.Admin Validation Language') }}</title>
@endsection
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h4>{{ __('admin.Admin Validation Language') }}</h4>
                                <button type="button" id="translateAll" class="btn btn-primary"
                                    data-code="{{ request('code') }}"
                                    data-file="admin_validation">{{ __('admin.Translate All') }}</button>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('admin.update-admin-validation-language', request('code')) }}"
                                    method="post">
                                    @csrf
