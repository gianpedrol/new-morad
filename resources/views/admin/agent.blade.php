...
@section('title')
<title>{{__('admin.Our Agent')}}</title>
@endsection
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>{{__('admin.Our Agent')}}</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="{{ route('admin.dashboard') }}">{{__('admin.Dashboard')}}</a></div>
              <div class="breadcrumb-item">{{__('admin.Our Agent')}}</div>
            </div>
          </div>
                            ...
                            <tbody>
                                @foreach ($customers as $index => $customer)
                                    <tr>
                                        ...
                                        <a href="{{ route('admin.agent-show',$customer->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></a>
