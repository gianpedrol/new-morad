...
class StaffPropertyController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('staff.property')->with([
    ...
    public function create()
    {
        ...
        return view('staff.create_property')->with([
            'cities' => $cities,
            'purposes' => $purposes,
            'aminities' => $aminities,
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('staff.property.index')->with($notification);
    }
    ...
    public function edit(Property $property)
    {
        ...
        return view('staff.edit_property')->with([
            'property' => $property,
            'propertyTypes' => $propertyTypes,
            'cities' => $cities,
            'purposes' => $purposes,
